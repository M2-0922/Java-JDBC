...
public class EmployeeDAOMysqlimpl implements EmployeeDAO {
    ...
    "(name, department,daysAbsent,salary, WHERE id)" +
    "VALUES (?, ?, ?, ?, ?)";

    private static final String UPDATE_EMPLOYEE_2 = 
        "UPDATE employee_table SET WHERE id = ?";
    ...
    public void updateEmployee(int id) {
        ...
        try {
            preparedStatement = connection.prepareStatement(UPDATE_EMPLOYEE_2);
            preparedStatement.setInt(1, id);
